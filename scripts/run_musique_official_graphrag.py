"""Run official Microsoft GraphRAG on a prepared MuSiQue pilot set."""
...
def main() -> None:
    ...
    parser.add_argument("--graphrag-root", default="evaluation/results/musique_graphrag_20")
    ...
    parser.add_argument("--output", default="evaluation/results/musique_official_graphrag_20.json")
